...
| 2 | `ich_bin_die_beste` | mehrmals je Spiel, aus vier Anlässen | muss zu vier verschiedenen Momenten passen |
| 3 | `mein_carry_rettet` | höchstens 1× je Ball | darf triumphieren, kommt aber regelmäßig |
...
Dateien, deren Name in keinem Fach steht, werden vom Spiel nicht angefasst -
sie liegen hier nur herum. Das gilt auch für `0 Lead Vocal.wav` und
`0 Lead Vocal.mp3`.
...
|---|---|---|
| Sprüche der Queen | `assets/voice/<fach>.ogg` | Namen aus Abschnitt 7 |
