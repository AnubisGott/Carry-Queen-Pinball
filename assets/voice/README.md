...
Liegen mehrere Fassungen da, zieht das Spiel sie aus einem Topf: erst wenn  
jede einmal dran war, wird neu gemischt. Über drei Bälle hörst du so alles,  
was du aufgenommen hast, und **nie zweimal hintereinander dieselbe**. Genauso  
gut geht es ohne Ordner: dann heißt die Datei wie das Fach, also  
`assets/voice/kein_skill.mp3`.
...
**Sie redet nie durcheinander.** Läuft noch ein Satz - oder ist er eben erst  
zu Ende - dann wird der nächste nicht gesprochen, sondern **geschrieben**: er  
erscheint im Chat unter ihrem Namen. Verloren geht nichts, es überlagert sich  
nur nichts mehr. Nach jedem Satz bleibt es dafür 0,8 Sekunden still.

Sätze, die der Reihe nach zu einem anderen gehören - der Spott beim  
Ballwechsel, „Gern geschehen" nach dem Carry-Save, der Carry-Save selbst, das  
Schlusswort - warten erst kurz ab, statt gleich in den Chat zu gehen. Gemessen  
über fünf Spiele: knapp anderthalb Sätze je Spiel werden geschrieben.

Der Begrüßungssatz eines neuen Spiels wird immer gesprochen - ein neuer Start  
schneidet das Schlusswort des alten ab.
